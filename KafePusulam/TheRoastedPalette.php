...
if (isset($_POST['mesaj2'])) {
    ...
    $insertSql = "INSERT INTO siparis_theroasted (kullanici, siparis) VALUES ('$kullanici', '$siparis')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['yildiz'][0]) && isset($_POST['yorum'])) {
    ...
    $yorum = $_POST['yorum'];
        ...
        $insertSql = "INSERT INTO yorumtheroasted (kullanici, yorum, yildiz, tarih) VALUES ('$kullanici', '$yorum', '$yildiz', '$tarih')";
        if ($baglanti->query($insertSql) === TRUE) {
...
$selectSql = "SELECT * FROM yorumtheroasted ";
...
<head>
    ...
    <title>The Roasted Palette</title>
