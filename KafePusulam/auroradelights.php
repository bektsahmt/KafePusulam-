...
$selectSql = "SELECT * FROM yorumlar";
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        <div class="yorum">
            ...
            <div class="right">
                ...
                <br>
                <p class="tarih"><?= date_format(date_create($row["tarih"]), "d.mY");
                 ?></p>
                <br>
